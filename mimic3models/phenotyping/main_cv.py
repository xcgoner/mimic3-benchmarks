...
from mimic3benchmark.readers import PhenotypingReaderCV
...
for train_index, test_index in kf.split(listfile_data):
    ...
    train_reader = PhenotypingReaderCV(dataset_dir='../../data/phenotyping/train/',
                                    listfile='../../data/phenotyping/val_listfile.csv', listfile_data = np.ndarray.tolist(listfile_data[train_index]))

    val_reader = PhenotypingReaderCV(dataset_dir='../../data/phenotyping/train/',
                                listfile='../../data/phenotyping/val_listfile.csv', listfile_data = np.ndarray.tolist(listfile_data[train_index]))
