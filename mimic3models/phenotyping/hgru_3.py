...
class Network(Model):
    ...
    def __init__(self, dim, batch_norm, dropout, rec_dropout, task,
        ...
        L_lv1 = GRU(units=dim,
                 ...
                 dropout=dropout,
                 recurrent_dropout=rec_dropout, name="L_lv1")(mX)
        ...
        output_lv1 = Dense(num_superclass, activation=final_activation, name="output_lv1")(output_lv1)

        L_lv2_gru = GRU(units=dim,
                 activation='tanh',
                 return_sequences=return_sequences,
                 dropout=dropout,
                 recurrent_dropout=rec_dropout, name="L_lv2_gru")(L_lv1)
        ...
        L_lv2_2 = GRU(units=dim,
                 ...
                 return_sequences=return_sequences,
                 dropout=dropout,
                 recurrent_dropout=rec_dropout, name="L_lv2_2")(mX)

        output_lv2 = Dense(25, activation=final_activation, name="output_lv2")(Concatenate()([L_lv2_gru, L_lv2_2]))
    ...
    def say_name(self):
        self.network_class_name = "k_hgru_3"
