...
from mimic3benchmark.readers import PhenotypingReaderMem
...
train_reader = PhenotypingReaderMem(dataset_dir='../../data/phenotyping/train/',
                                 listfile='../../data/phenotyping/train_listfile.csv')

val_reader = PhenotypingReaderMem(dataset_dir='../../data/phenotyping/train/',
...
if args.mode == 'train':
    ...
    test_reader = PhenotypingReaderMem(dataset_dir='../../data/phenotyping/test/',
